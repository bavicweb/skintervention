<div class='projects_holder_outer v<?php echo esc_attr( $columns );?> <?php echo implode(" ", $portfolio_holder_classes) ?>'>
    ...
    <div class='projects_holder portfolio_main_holder clearfix v<?php echo esc_attr($columns); ?> <?php echo implode(' ', $_type_class ); ?> <?php echo bridge_core_generate_portfolio_list_thumbs_size_class( $params );?> <?php esc_attr( $portfolio_loading_class ); ?>'>
